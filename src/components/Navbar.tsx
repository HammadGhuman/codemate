    ...
    >
      ...
      >
        ...
        <div className="flex lg:flex-row justify-between w-full lg:w-auto items-center space-x-3 flex-row-reverse">
          <div
            className="absolute top-0 lg:static -left-8 lg:left-0 cursor-pointer"
            onClick={() => {
              window.scrollTo({
                top: 0,
                behavior: "smooth",
        ...
        {/* Home-->Services-->Projects-->Recommendations-->Our Story-->Contact us */}
        {
          <>
            <div
              className={`flex lg:flex-row lg:space-x-10 ${
                !open && "hidden lg:flex"
              } flex-col space-y-5 lg:space-y-0 lg:my-0 my-10  w-full lg:w-auto items-center font-semibold`}
            >
              <Link
          ...
          >
            ...
            <Link
              ...
              className={`${
                !open && "hidden lg:flex"
              } px-4 py-3 outline outline-2 lg:outline-white lg:bg-transparent  lg:w-auto  w-full text-center lg:text-white rounded-md font-bold hover:bg-primary bg-white hover:text-white hover:outline-none text-red-950  outline-red-950 transition-colors duration-300`}
              href={"#"}
            >
              Contact Us
            </Link>
