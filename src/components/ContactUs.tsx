    ...
    <div id="contact" className='flex lg:flex-row flex-col font-mono min-h-screen overflow-y-hidden text-gray-100'>
      ...
      <div className='pt-10 w-full bg-slate-100'>
        ...
        <div className='mt-5 flex items-center justify-center' >
          <form  action="https://formsubmit.co/manan@codematetechnologies.com" method="POST" className='flex flex-col px-5 lg:space-y-16 space-y-10 items-start w-full bg-white lg:px-20 py-10  shadow-xl'>
            <input type="text" className="outline-none rounded-lg text-xl py-3 px-3 bg-slate-100 w-full text-primary placeholder:text-slate-300" placeholder='Name' name="name" />
            <input type="text" className="outline-none rounded-lg text-xl py-3 px-3 bg-slate-100 w-full text-primary placeholder:text-slate-300" placeholder='Email' name="email" />
            <input type="text" className="outline-none rounded-lg text-xl py-3 px-3 bg-slate-100 w-full text-primary placeholder:text-slate-300" placeholder='Contact Number' name="number" />
            <input type="text" className="outline-none rounded-lg text-xl py-3 px-3 bg-slate-100 w-full text-primary placeholder:text-slate-300" placeholder='Project Description' name="projectDes" />
            <button type='submit' className='ml-auto px-12 rounded-lg hover:bg-primary text-xl font-semibold py-3 text-black outline outline-primary transition-colors duration-300'>Submit</button>
          </form>
        </div>
      </div>
    </div>  
