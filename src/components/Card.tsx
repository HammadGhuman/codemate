...
const Card = ({cardBg,Word1,Word2,Word3,para}: Props) => {
  ...
  return (
    <motion.div className="w-[350px] h-[430px] relative rounded-xl text-red-950 shadow-lg shadow-primary">
      ...
      <motion.h1 initial={{opacity:0,y:100}} animate={{opacity:1,y:0}} transition={{duration:3}}  className={`text-2xl ${exp ? 'mt-9' : 'mt-5'} font-semibold text-center px-4`}>
