...
function Services({}: Props) {
  ...
  return (
    <div id="services" className='relative overflow-y-hidden'>  
        ...
        <ServiceCard key={2} color={'bg-secondary'}heading={"Mobile App Development"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Id unde culpa vel fugit accusamus voluptate ab fugiat, nemo molestias explicabo!"} techName={["Flutter","Node Js","Typescript","Firebase"]} AnimationData={Mobile}/>
